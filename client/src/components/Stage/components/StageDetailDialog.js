// app/stages/components/StageDetailDialog.js
"use client";
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-primary/10 rounded-lg p-4">
              <h3 className="text-lg font-medium text-foreground mb-2">Informations du Stage</h3>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{formatDate(stage.start_date)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Calendar className="h-4 w-4 text-primary" />
                  <div>
                    ...
                    <p className="font-medium text-foreground">{formatDate(stage.end_date)}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{stage.stagiaires?.length || 0}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{stage.specialites?.length || 0}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{stage.brigades?.length || 0}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-border">
              <div className="flex -mb-px">
                ...
                >
                  ...
                  Stagiaires ({stage.stagiaires?.length || 0})
                </button>
                <button
                ...
                >
                  ...
                  Spécialités ({stage.specialites?.length || 0})
                </button>
                <button
                ...
                >
                  ...
                  Brigades ({stage.brigades?.length || 0})
                </button>
              </div>
            </div>
