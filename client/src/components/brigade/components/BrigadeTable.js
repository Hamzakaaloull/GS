...
import { MoreVertical, Eye, Edit, Trash2, Users, BookOpen, Calendar, MapPin } from "lucide-react";
  ...
  {brigade.specialite?.name || "Aucune"}
              ...
              <td className="p-4">
                <div className="flex justify-end">
                  <div 
                    className="relative" 
                    ref={el => dropdownRefs.current[brigade.documentId] = el}
                  >
                    <button
                    ...
                    {activeDropdown === brigade.documentId && (
                      <div className="absolute right-0 top-full mt-1 w-48 bg-card border border-border rounded-lg shadow-lg z-50">
                        <div className="py-1">
                          ...
                          >
                            {loadingDelete && selectedBrigade?.documentId === brigade.documentId ? (
