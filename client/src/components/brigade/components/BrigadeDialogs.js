// app/brigades/components/BrigadeDialogs.js
"use client";
import React from "react";
import { X, Check, AlertCircle } from "lucide-react";

export default function BrigadeDialogs({
  openConfirm,
  onCloseConfirm,
      ...
      {openConfirm && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-card border border-border rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="p-4">
              <p className="text-foreground">Êtes-vous sûr de vouloir supprimer cette brigade ?</p>
            </div>
